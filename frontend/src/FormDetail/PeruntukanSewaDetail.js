...
function PeruntukanSewaDetail() {
  ...
  return (
    <div style={{ padding: '20px', fontFamily: 'Arial' }}>
      <h2 style={{ borderLeft: '5px solid #3949AB', paddingLeft: '10px' }}>Detail Peruntukan Sewa</h2>
      <div style={{ background: '#f9f9f9', padding: '20px', marginTop: '20px', borderRadius: '4px' }}>
        <p><strong>Jenis Kegiatan:</strong> {data.jenisKegiatan}</p>
        <p><strong>Peruntukan:</strong> {data.peruntukanSewa}</p>
...
export default PeruntukanSewaDetail;
